...
function BankingANDFinance() {
  const careers = [
    ...
    },
    {
      ...
      icon: TAXIcon,
      description: "TAX consultants provide expert advice on tax planning, compliance, and strategy."
    },
    {
      id: "ib",
      title: "Investment Banker",
      icon: IBIcon,
      description: "Investment bankers provide financial advice and facilitate mergers, acquisitions, and other complex financial transactions."
    },
    {
      id: "credit-analyst",
      title: "Credit Analyst",
      icon: CreditAnalystIcon,
      description: "Credit analysts evaluate the creditworthiness of individuals and businesses."
    },
    {
      id: "bm",
      title: "Bank Manager",
      icon: BMIcon,
      description: "Bank managers oversee daily operations, manage staff, and ensure compliance with regulations."
    },
    ...
    <div className="banking-finance-page">
      ...
      <section className="hero-section">
        <div className="hero-left">
          ...
          <p>
            Discover exciting career opportunities in the banking and finance sector, offering stability, growth, and the chance to work with leading financial institutions.
          </p>
