  ...
  return (
    <div className="computer-page">
      ...
      <div className="computer-sidebar">
        ...
        <div className="computer-sidebar-top">

          <div className="computer-career-card">
          ...
          <ul>
            ...
            {tabs.map((tab) => (
              <li
                key={tab}
                className={activeTab === tab ? "computer-active" : ""}
        ...
        <button className="computer-save-btn">
          ❤ Save Career
        </button>
      ...
      <div className="computer-content">
        ...
        <div className="computer-header">
          ...
          <img
            src={ComputerBanner}
            alt=""
            className="computer-banner-image"
          />
        ...
        <div className="computer-top-tabs">

          {tabs.map((tab) => (
            <button
              key={tab}
              className={activeTab === tab ? "computer-tab computer-active-tab" : "computer-tab"}
              onClick={() => setActiveTab(tab)}
            >
              {tab}
            </button>
        ...
        <div className="computer-tab-content">

          {activeTab === "Overview" && (
            <>
              <h2>About Computer Engineering</h2>

              <p className="computer-about-text">
              ...
              <div className="computer-info-card">
                ...
                <div className="computer-info-row">
                  <div className="computer-label">🎓 Educational Path</div>
                ...
                <div className="computer-info-row">
                  <div className="computer-label">💻 Required Skills</div>
                  <div className="computer-value">
                ...
                <div className="computer-info-row">
                  <div className="computer-label">📝 Top Exams</div>
                  <div className="computer-value">
                ...
                <div className="computer-info-row">
                  <div className="computer-label">📈 Future Scope</div>
                  <div className="computer-value">
                ...
                <div className="computer-info-row">
                  <div className="computer-label">💰 Average Salary</div>
                  <div className="computer-value">
                ...
                <div className="computer-info-row">
                  <div className="computer-label">🧑‍💼 Day to Day Work</div>
                  <div className="computer-value">
          ...
          {activeTab === "Skills" && (
            <>
              ...
              <ul className="computer-skill-list">
          ...
          {activeTab === "Scope" && (
            <>
              ...
              <div className="computer-info-card">
                ...
                <div className="computer-info-row">
                  <div className="computer-label">💼 Top Job Roles</div>
                  <div className="computer-value">
                ...
                <div className="computer-info-row">
                  <div className="computer-label">🏢 Top Recruiters</div>
                  <div className="computer-value">
          ...
          {activeTab === "Salary" && (
            <>
              ...
              <div className="computer-info-card">
                ...
                <div className="computer-info-row">
                  <div className="computer-label">🎓 Fresher</div>
                  <div className="computer-value">
                    ₹4 LPA – ₹8 LPA
                  </div>
                </div>
                ...
                <div className="computer-info-row">
                  <div className="computer-label">💼 Mid Level</div>
                  <div className="computer-value">
                    ₹8 LPA – ₹15 LPA
                  </div>
                </div>
                ...
                <div className="computer-info-row">
                  <div className="computer-label">⭐ Experienced</div>
                  <div className="computer-value">
                    ₹15 LPA – ₹25+ LPA
                  </div>
                </div>
